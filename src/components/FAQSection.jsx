    ...
    >
      <div className="w-full max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <p className="text-red-500 text-sm uppercase font-medium tracking-wider mb-1">
            NOTRE SUPPORT
          </p>
          <h2 className="text-4xl font-bold mb-4">BESOIN D'AIDE ?</h2>
          <p className="text-gray-400 text-sm max-w-7xl mx-auto">
            Vous avez une question ou un souci ? Consultez notre support d'aide
            pour trouver des réponses rapides.
            <br />
