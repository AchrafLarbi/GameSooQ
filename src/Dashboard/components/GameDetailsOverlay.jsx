      ...
      <div className="flex flex-col max-w-2xl w-full mx-auto bg-black text-white overflow-hidden rounded-3xl">
        ...
        <div className="relative">
          ...
          >
            ...
            {/* Navigation arrows */}
            <button className="absolute left-2 top-1/2 -translate-y-1/2 bg-gray-200 bg-opacity-50 rounded-full p-2 text-gray-800 z-10">
              &lt;
            </button>
            <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-gray-200 bg-opacity-50 rounded-full p-2 text-gray-800 z-10">
              &gt;
            </button>
        ...
        <div className="bg-zinc-800 text-white p-4 flex justify-between items-center">
          <h2 className="text-2xl font-bold">
            {transaction_type === "sell" ? "Price" : "Game"}
          </h2>
